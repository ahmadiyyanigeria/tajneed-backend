...
public class MembershipInfo(string surname, string firstName, string auxiliaryBodyId, string middleName, DateTime dob, string email, string phoneNo, Sex sex, MaritalStatus maritalStatus, string address, EmploymentStatus employmentStatus)
{
