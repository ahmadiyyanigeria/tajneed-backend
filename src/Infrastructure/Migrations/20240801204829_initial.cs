...
public partial class initial : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            name: "auxillary_bodies",
            columns: table => new
            {
                id = table.Column<string>(type: "text", nullable: false),
                auxillary_body_name = table.Column<string>(type: "text", nullable: false),
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_auxillary_bodies", x => x.id);
            });
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                auxillary_body_id = table.Column<string>(type: "text", nullable: false),
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_members_auxillary_bodies_auxillary_body_id",
                    column: x => x.auxillary_body_id,
                    principalTable: "auxillary_bodies",
                    principalColumn: "id",
                    onDelete: ReferentialAction.Restrict);
                table.ForeignKey(
        ...
        migrationBuilder.CreateIndex(
            name: "IX_members_auxillary_body_id",
            table: "members",
            column: "auxillary_body_id");
