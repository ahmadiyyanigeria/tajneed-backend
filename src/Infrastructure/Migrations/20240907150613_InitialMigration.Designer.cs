...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240907150613_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.CaseAggregateRoot.BiodataUpdateCase", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Entities.CaseAggregateRoot.CaseType", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Entities.CaseAggregateRoot.DuplicateAccountCase", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Entities.CaseAggregateRoot.RelocationCase", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Entities.CaseAggregateRoot.BiodataUpdateCase", b =>
                {
                    b.HasOne("Domain.Entities.CaseAggregateRoot.Case", "Case")
                        .WithMany()
                        .HasForeignKey("CaseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entities.HouseHoldAggregateRoot.HouseHoldMember", "HouseholdMember")
                        .WithMany()
                        .HasForeignKey("HouseholdMemberId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entities.JamaatAggregateRoot.Jamaat", "Jamaat")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.CaseAggregateRoot.Case", b =>
                {
                    b.HasOne("Domain.Entities.CaseAggregateRoot.CaseType", "CaseType")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.CaseAggregateRoot.RelocationCase", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.JamaatAggregateRoot.Jamaat", "NewJamaat")
                        .WithMany()
                        .HasForeignKey("NewJamaatId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entities.JamaatAggregateRoot.Jamaat", "OldJamaat")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.MemberAggregateRoot.Member", b =>
                {
                    b.HasOne("Domain.Entities.JamaatAggregateRoot.AuxiliaryBody", "AuxiliaryBody")
                        .WithMany()
